                ...
                <Slider>
                    ...
                    <div className="player">
                        ...
                        <div className="player-info">
                            ...
                            <p> Height: 1.72m (5 ft 7 in) </p>
                            <p> Weight: 68kg (150 lb) </p>
                            <p> Dominant hand: Right-hand </p>
                    ...
                    <div className="player">
                        ...
                        <div className="player-info">
                            ...
                            <p> Country: India </p>
                            <p> Height: 1.78m (5 ft 10 in) </p>
                            <p> Weight: 66kg (146 lb) </p>
                            <p> Dominant hand: Right-hand </p>
                    ...
                    <div className="player">
                        ...
                        <div className="player-info">
                            ...
                            <p> Country: Denmark </p>
                            <p> Height: 1.94m (6 ft 4 in) </p>
                            <p> Weight: 88g (194 lb) </p>
                            <p> Dominant hand: Right-hand </p>
                    ...
                    <div className="player">
                        ...
                        <div className="player-info">
                            ...
                            <p> Country: China </p>
                            <p> Height: 1.84m (6 ft 0 in) </p>
                            <p> Weight: Unknown </p>
                            <p> Dominant hand: Right-hand </p>
                            <p> Current ranking: 3 ( 5 July 2018) </p>
                        </div>
                        <div className="player-intro">
                            Shi Yuqi is a Chinese badminton player. An up-and-coming name in badminton, Shi Yuqi won his first SuperSeries title at the French Open on 30 October 2016 after he beat Lee Hyun Il from Korea with a score of 21-16, 21-19.  Since then the young badminton star has proved that he is one of the top players in the men's singles discipline. At the 2017 All England Open, he beat 6-time champion Lin Dan to reach the final, and repeated that again at the 2018 All England Open, in which Shi Yuqi outclassed Lin Dan in the tournament final, winning the prestigious tournament for the first time in his career.
                        </div>
                    </div>
                </Slider>
            </div>
